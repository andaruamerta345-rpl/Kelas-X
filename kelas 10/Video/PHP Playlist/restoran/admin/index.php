        ...
        <div class="row mt-4">
            ...
            <div class="col-md-9">
                ...
                <div class="float-end mt-4 me-4">
                    user : <a href="?f=user&m=updateuser&id=<?= $_SESSION['iduser'] ?>"><?= $_SESSION['user'] ?></a>
                </div>
                <div class="float-end mt-4 me-4">LEVEL : <?=$_SESSION['level']?> </div>
            </div>
        </div>
                                ...
                                echo '
                                     <div class="d-flex justify-content-center">
                                        <div class="alert alert-danger text-center w-50 mt-3">
                                            Anda tidak menunjukkan Level anda
                                        </div>
                                    </div>
                                ';
                                break;
